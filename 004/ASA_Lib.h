...
char UART_set(char ASAID, char ID, char LSByte, char Mask, char Shift, char Data);
char UART_put(char ASAID, char ID, char LSByte, char Bytes, void *Data_p);
char UART_get(char ASAID, char ID, char LSByte, char Bytes, void *Data_p);
char UART_fpt(char ASAID, char ID, char LSByte, char Mask, char Shift, char Data);
char UART_fgt(char ASAID, char ID, char LSByte, char Mask, char Shift, char *Data);
char UART485_set(char ASAID, char ID, char LSByte, char Mask, char Shift, char Data);
char UART485_put(char ASAID, char ID, char LSByte, char Bytes, void *Data_p);
char UART485_get(char ASAID, char ID, char LSByte, char Bytes, void *Data_p);
char UART485_fpt(char ASAID, char ID, char LSByte, char Mask, char Shift, char Data);
char UART485_fgt(char ASAID, char ID, char LSByte, char Mask, char Shift, char *Data);
