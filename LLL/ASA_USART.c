...
char M128_UART_set(char LSByte, char Mask, char shift, char Data){
	...
	switch(LSByte){
		case 200:
			bits_put(Data, UCSR1A, Mask, shift);
			break;
		case 201:
			bits_put(Data, UCSR1B, Mask, shift);
			break;
		case 202:
			bits_put(Data, UCSR1C, Mask, shift);
			break;
		case 203:
			bits_put(Data, UBRR1L, Mask, shift);
			break;
		case 204:
		bits_put(Data, UBRR1H, Mask, shift);
		break;
	}
	return 0;
}
